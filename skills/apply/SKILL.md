...
- `/see:apply` - Start the flow (will ask for a job URL or use the most recent job)
- `/see:apply https://...` - Apply to a specific job posting
- `/see:apply last` - Apply using the most recent job folder
- `/see:apply current` - Fill the application form already open in the active browser tab
